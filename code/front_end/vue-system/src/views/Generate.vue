<template>
  <div class="container" style="min-height: 100%;min-width: 60%; padding-bottom: 100px;">
    <!-- test -->
  <div>
    	<router-link to="/information/authors/651288ceeb11a940d8e47974">Go to Author Page</router-link>
  </div>
	<div>
    	<router-link to="/information/papers/651288cfeb11a940d8e47976">Go to Paper Page</router-link>
  </div>
  <!-- test -->
    <el-container>
      <el-header></el-header>
